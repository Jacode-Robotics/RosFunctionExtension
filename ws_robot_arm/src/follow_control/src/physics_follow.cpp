...
void motion_physical::dyn_cb(follow_control::dynamic_paramConfig& config, uint32_t level)
{
    ...
    MasterDxl.Gripper_pid[config.joint].vel_ratio = config.joint_vel_ratio;
    MasterDxl.Gripper_pid[config.joint].Kp = config.joint_pid_Kp;
    MasterDxl.Gripper_pid[config.joint].Ki = config.joint_pid_Ki;
    MasterDxl.Gripper_pid[config.joint].Kd = config.joint_pid_Kd;
    SlaveDxl.Gripper_pid[config.joint].vel_ratio = config.joint_vel_ratio;
    SlaveDxl.Gripper_pid[config.joint].Kp = config.joint_pid_Kp;
    SlaveDxl.Gripper_pid[config.joint].Ki = config.joint_pid_Ki;
    SlaveDxl.Gripper_pid[config.joint].Kd = config.joint_pid_Kd;
